...
const onSubmit = async ({ identity, password }) => {
  try {
    ...
    await signInWithEmailAndPassword(auth, identity.trim(), password);

    // ✅ DO NOT fetch profile or navigate here
    // Root navigator will handle routing automatically
