...
import { createNewUserDoc,  setLoading } from "../../react-redux-store/store-comp/authSlice";
...
const NewUsersForm = () => {
  ...
  // const [loading, setLoading] = useState(false);
    const { user, hasPreferences, loading } = useSelector(
...
const onSubmit = async (data) => {
  ...
  try {
    const { email, password, fullName, phone, gender, dob } = data;
