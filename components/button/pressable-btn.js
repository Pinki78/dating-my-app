...
const PressableBtn = (props) => {
    ...
    const { btnText, onPress, imageClass, imageSource, iconName, ClassiconName, altText, TouchableBtn, btnContentClass, } = props;
    ...
    return (
        <>
            ...
            >
                <View style={[styles.btnContent, btnContentClass]}>
                    {imageSource ? (
